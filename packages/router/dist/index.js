...
function useRouter() {
  const ctx = import_react.useContext(RouterContext);
...
function Router({ routes }) {
  const [currentRoute, setCurrentRoute] = import_react.useState(null);
  const [params, setParams] = import_react.useState({});
  ...
  return import_react.default.createElement(RouterContext.Provider, {
    value: {
      currentRoute,
      params,
      navigate,
  ...
  }, Component ? import_react.default.createElement(Component, { params }) : import_react.default.createElement(NotFound, null));
}
function Link({ to, children, ...props }) {
  ...
  return import_react.default.createElement("a", { href: to, onClick: handleClick, ...props }, children);
}
function SSRRouter({ routes, initialPath = "/" }) {
  ...
  if (!isClient) {
    for (const route of routes) {
      if (route.path === initialPath) {
        return import_react.default.createElement(RouterContext.Provider, { value: { currentRoute: route, params: {}, navigate: () => {}, pathname: initialPath, isSSR: true } }, import_react.default.createElement(route.component, { params: {} }));
      }
    }
  }
  const Component = currentRoute?.component ?? null;
...
function NotFound() {
  return import_react.default.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", fontFamily: "system-ui" } }, import_react.default.createElement("h1", { style: { fontSize: "6rem", margin: 0 } }, "404"), import_react.default.createElement("p", { style: { fontSize: "1.5rem", color: "#666" } }, "Page not found"), import_react.default.createElement("a", { href: "/", style: { color: "#10b981", textDecoration: "none" } }, "Go home"));
}
export {
  useRouter,
  SSRRouter,
